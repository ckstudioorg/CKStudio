    ...
    <Section className="bg-white">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 mb-12">
        {clientLogos.map((client, index) => (
          <div 
            key={index} 
            className="bg-white border-2 border-gray-200 rounded-lg p-6 flex items-center justify-center hover:border-red-600 hover:shadow-xl transition-all duration-300 hover:scale-105 aspect-video"
          >
            <img 
              src={client.logo} 
              alt={client.name}
